...
namespace KPMEngineeringB.R
{
    public partial class Form3 : System.Windows.Forms.Form
    {
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            ...
            double defaluteWidth;
            double.TryParse(tb_Width.Text, out defaluteWidth);
            double tempWidth = defaluteWidth;
            if (tempWidth == 0)
            {
                ctWidth = 200/304.8;
            }
            ...
            {
                ctWidth = defaluteWidth / 304.8;
            }
            double defaluteHeight;
            double.TryParse(tb_Height.Text, out defaluteHeight);
            double tempHeight = defaluteHeight;
            if (tempHeight == 0)
            {
                ctHeight = 200 / 304.8;
            }
