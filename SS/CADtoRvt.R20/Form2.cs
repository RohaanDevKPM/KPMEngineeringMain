...
namespace KPMEngineeringB.R
{
    public partial class Form2 : System.Windows.Forms.Form
    {
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            ...
            double defaultDuctWidth;
            double.TryParse(tb_Duct_Width.Text, out defaultDuctWidth);
            double tempDuctW = defaultDuctWidth;
            if (tempDuctW == 0)
            {
                ductWidth = 300/304.8;
            }
            ...
            {
                ductWidth = defaultDuctWidth / 304.8;
            }
            double defaultDuctHeight;
            double.TryParse(tb_Duct_Height.Text, out defaultDuctHeight);
            double tempDuctH = defaultDuctHeight;
            if (tempDuctH == 0)
            {
            ...
            {
                ductHeight = defaultDuctHeight / 304.8;
            }
            double defaultDuctDiameter;
            double.TryParse(tb_Duct_Diameter.Text, out defaultDuctDiameter);
            double tempDuctD = defaultDuctDiameter;
            if (tempDuctD == 0)
            {
            ...
            {
                ductDiameter = defaultDuctDiameter / 304.8;
            }
