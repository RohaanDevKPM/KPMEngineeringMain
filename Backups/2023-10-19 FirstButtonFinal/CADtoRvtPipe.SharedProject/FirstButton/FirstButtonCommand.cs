...
namespace CADtoRvtPipe.R.FirstButton
{
    ...
    public class FirstButtonCommand : IExternalCommand
    {
        ...
        public static void CreateBtn(RibbonPanel panel)
        {
                ...
                MethodBase.GetCurrentMethod().DeclaringType?.FullName)
            {
                ...
                "Ensure Pipe Size entered is avaliable in Routing Preference else it will select nearby avaliable Pipe Size.",
        ...
        public string setDate = "2023-10-31";
    }
}
